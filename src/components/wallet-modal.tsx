            ...
            <div className="space-y-6">
              <div className="flex flex-col gap-3">
                <p className="text-sm text-gray-600 mb-1">
                  Connect your existing wallet or create a new one to continue.
                </p>
                <Button
                  className="w-full"
                  color="secondary"
                ...
                <p className="text-xs text-gray-500 mt-1 mb-2">
                  Note: Generated wallets persist only for this session. Export
                  and save the private key for future use.
                </p>
              </div>
